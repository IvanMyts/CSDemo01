...
namespace CSConsoleApp
{
    public static class Program
    {
        public static void Main()
        {
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task1.txt", string.Join(Environment.NewLine, spielbergMovies));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task2.txt", string.Join(Environment.NewLine, tomHanksCharacters));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task3.txt", string.Join(Environment.NewLine, top5MoviesByCastSize.Select(m => $"{m.Title} — {m.CastCount} актёров")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task4.txt", string.Join(Environment.NewLine, top10Actors.Select(a => $"{a.ActorName} — {a.MovieCount} фильмов")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task5.txt", string.Join(Environment.NewLine, uniqueDepartments));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task6.txt", string.Join(Environment.NewLine, hansZimmerMovies));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task7.txt", string.Join(Environment.NewLine, directorByMovieId.Select(kvp => $"{kvp.Key} -> {kvp.Value}")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task8.txt", string.Join(Environment.NewLine, pittAndClooneyMovies));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task9.txt", totalCameraCrew.ToString());
            ...
            if (titanic != null)
            {
                ...
                File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task10.txt", string.Join(Environment.NewLine, bothCrewCast));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task11.txt", string.Join(Environment.NewLine, tarantinoCrew.Select(m => $"{m.CrewMember} — {m.MovieCount} фильмов")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task12.txt", string.Join(Environment.NewLine, duetCounts.Select(d => $"{d.A} и {d.B} — {d.Count} фильмов")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task13.txt", string.Join(Environment.NewLine, diversityIndex.Select(d => $"{d.Name} - {d.Depts} департаментов")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task14.txt", string.Join(Environment.NewLine, creativeTrios));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task15.txt", string.Join(Environment.NewLine, secondLevel));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task16.txt", string.Join(Environment.NewLine, directorStats.Select(d => $"{d.Director}: Cast {d.AvgCast:F1}, Crew {d.AvgCrew:F1}")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task17.txt", string.Join(Environment.NewLine, universals.Select(u => $"{u.Name} — {u.TopDept ?? "(неизвестно)"}")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task18.txt", string.Join(Environment.NewLine, both));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task19.txt", string.Join(Environment.NewLine, deptInfluence.Select(d => $"{d.Dept} — {d.AvgCast:F1}")));
            ...
            File.WriteAllText("C:\\Users\\super\\Downloads\\CSConsoleApp\\result\\task20.txt", string.Join(Environment.NewLine, deppRoles.Select(r => $"{r.Word} — {r.Count}")));
